...
class RecordApiHelper
{
    ...
    public function insertRecord($data, $actions)
    {
        ...
        if ($subscriber && isset($actions->skip_if_exists) && $actions->skip_if_exists) {
            ...
            if (!$subscriber) {
                ...
                $subscriber = FluentCommunityApi('contacts')->createOrUpdate($data, false, false);
                ...
                $subscriber = FluentCommunityApi('contacts')->createOrUpdate($data, $forceSubscribed, false);
    ...
    public function insertDeleteTag($data, $actionName)
    {
        ...
        unset($data['tags']);
        FluentCommunityApi('contacts')->createOrUpdate($data, false, false);
