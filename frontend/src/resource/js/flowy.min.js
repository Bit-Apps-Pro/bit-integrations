  ...
  ;((flowy.load = function () {
    if (!d) {
      ...
      ;(window.getComputedStyle(s).position != 'absolute' &&
        ...
        ((u = s.getBoundingClientRect().left), (p = s.getBoundingClientRect().top))
      var g
      var w
      var f
      let h
      ...
      ;(L.classList.add('indicator'),
        ...
        (flowy.output = function () {
          const e = { html: s.innerHTML, blockarr: i, blocks: [] }
          if (i.length > 0) {
            for (var t = 0; t < i.length; t++) {
              e.blocks.push({ id: i[t].id, parent: i[t].parent, data: [], attr: [] })
              const l = document.querySelector(`.blockid[value='${i[t].id}']`).parentNode
        ...
        (flowy.beginDrag = function (e) {
          if (
            ((window.getComputedStyle(s).position != 'absolute' &&
              ...
              ((u = s.getBoundingClientRect().left), (p = s.getBoundingClientRect().top)),
            e.targetTouches
              ? ((y = e.changedTouches[0].clientX), (C = e.changedTouches[0].clientY))
            ...
            ;(e.target.closest('.create-flowy').classList.add('dragnow'),
              ...
              i.length === 0
                ? ((l.innerHTML += `<input type='hidden' name='blockid' class='blockid' value='${i.length}'>`),
                  document.body.appendChild(l),
                  (g = document.querySelector(`.blockid[value='${i.length}']`).parentNode))
                : ((l.innerHTML += `<input type='hidden' name='blockid' class='blockid' value='${
                    Math.max.apply(
                      Math,
                      i.map(e => e.id)
                    ) + 1
        ...
        (flowy.endDrag = function (e) {
          if (e.which != 3 && (v || R))
            if (
              ...
              v && (h.classList.remove('dragnow'), g.classList.remove('dragging')),
              ...
              X('drop')
            else if (v && i.length == 0) q()
            else if (v)
              for (var t = i.map(e => e.id), o = 0; o < i.length; o++) {
                if (k(t[o])) {
                  ;((v = !1),
                    c(g, !1, document.querySelector(`.blockid[value='${t[o]}']`).parentNode)
                      ? T(g, o, t)
                      : ((v = !1), q()))
                  break
                }
        ...
        (flowy.moveBlock = function (e) {
          if (
            ...
            ;((b = i.filter(e => e.id == t)[0].parent),
              ...
              (i = i.filter(e => e.id != t)),
              t != 0 && document.querySelector(`.arrowid[value='${t}']`).parentNode.remove())
            for (var l = i.filter(e => e.parent == t), o = !1, r = [], d = []; !o; ) {
              for (var c = 0; c < l.length; c++)
                if (l[c] != t) {
                  ...
                  const t = document.querySelector(`.arrowid[value='${l[c].id}']`).parentNode
                  ;((e.style.left = `${
              ...
              r.length == 0 ? (o = !0) : ((l = i.filter(e => r.includes(e.parent))), (r = []))
            }
          ...
          if (
            (v
              ...
              : R &&
                ((g.style.left = `${y - w - (window.scrollX + u) + s.scrollLeft}px`),
                (g.style.top = `${C - f - (window.scrollY + p) + s.scrollTop}px`),
                (n.filter(e => e.id == parseInt(g.querySelector('.blockid').value)).x =
                  g.getBoundingClientRect().left +
                  window.scrollX +
                  parseInt(window.getComputedStyle(g).width) / 2 +
                  s.scrollLeft),
                (n.filter(e => e.id == parseInt(g.querySelector('.blockid').value)).y =
            ...
            y > s.getBoundingClientRect().width + s.getBoundingClientRect().left - 10 &&
            y < s.getBoundingClientRect().width + s.getBoundingClientRect().left + 10
              ? (s.scrollLeft += 10)
              : y < s.getBoundingClientRect().left + 10 && y > s.getBoundingClientRect().left - 10
                ? (s.scrollLeft -= 10)
                : C > s.getBoundingClientRect().height + s.getBoundingClientRect().top - 10 &&
                    C < s.getBoundingClientRect().height + s.getBoundingClientRect().top + 10
                  ? (s.scrollTop += 10)
              ...
              if (k(h[c])) {
                ;(document
                  ...
                  (document.querySelector('.indicator').style.left = `${
                    document.querySelector(`.blockid[value='${h[c]}']`).parentNode.offsetWidth / 2 - 5
                  }px`),
                  (document.querySelector('.indicator').style.top = `${
                    document.querySelector(`.blockid[value='${h[c]}']`).parentNode.offsetHeight
                  }px`),
    ...
    function k(e) {
      const t =
        ...
        s.getBoundingClientRect().left
      const l =
        g.getBoundingClientRect().top + window.scrollY + s.scrollTop - s.getBoundingClientRect().top
      return (
        t >= i.filter(t => t.id == e)[0].x - i.filter(t => t.id == e)[0].width / 2 - m &&
        t <= i.filter(t => t.id == e)[0].x + i.filter(t => t.id == e)[0].width / 2 + m &&
        l >= i.filter(t => t.id == e)[0].y - i.filter(t => t.id == e)[0].height / 2 &&
        l <= i.filter(t => t.id == e)[0].y + i.filter(t => t.id == e)[0].height
      )
    }
    function q() {
    ...
    function X(e) {
      if (e == 'drop')
        (c(g, !0, void 0),
          (v = !1),
          (g.style.top = `${
            g.getBoundingClientRect().top + window.scrollY - (p + window.scrollY) + s.scrollTop
          }px`),
          (g.style.left = `${
            g.getBoundingClientRect().left + window.scrollX - (u + window.scrollX) + s.scrollLeft
          }px`),
          s.appendChild(g),
          i.push({
            parent: -1,
        ...
        for (let t = 0; t < n.length; t++)
          if (n[t].id != parseInt(g.querySelector('.blockid').value)) {
            ...
            const l = document.querySelector(`.arrowid[value='${n[t].id}']`).parentNode
            ;((e.style.left = `${
              e.getBoundingClientRect().left + window.scrollX - window.scrollX + s.scrollLeft - 1 - u
            }px`),
              (e.style.top = `${
                e.getBoundingClientRect().top + window.scrollY - window.scrollY + s.scrollTop - p - 1
              }px`),
              (l.style.left = `${
                l.getBoundingClientRect().left + window.scrollX - window.scrollX + s.scrollLeft - u - 1
              }px`),
              (l.style.top = `${
                l.getBoundingClientRect().top + window.scrollY + s.scrollTop - 1 - p
              }px`),
              s.appendChild(e),
              s.appendChild(l),
              (n[t].x =
    ...
    function I(e, t, l, n) {
      ;(t < 0
        ? ((s.innerHTML += `<div class="arrowblock"><input type="hidden" class="arrowid" value="${
          ...
          } 0L${i.filter(e => e.id == n)[0].x - e.x + 5} ${B / 2}L5 ${
            B / 2
          }L5 ${l}" stroke="#C5CCD0" stroke-width="2px"/><path d="M0 ${l - 5}H10L5 ${l}L0 ${
            l - 5
          }Z" fill="#C5CCD0"/></svg></div>`),
          (document.querySelector(
            `.arrowid[value="${g.querySelector('.blockid').value}"]`
          ).parentNode.style.left = `${
            e.x - 5 - (u + window.scrollX) + s.scrollLeft + s.getBoundingClientRect().left
          }px`))
        : ((s.innerHTML += `<div class="arrowblock"><input type="hidden" class="arrowid" value="${
            g.querySelector('.blockid').value
          }"><svg preserveaspectratio="none" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M20 0L20 ${
            B / 2
          }L${t} ${B / 2}L${t} ${l}" stroke="#C5CCD0" stroke-width="2px"/><path d="M${t - 5} ${l - 5}H${
            t + 5
          }L${t} ${l}L${t - 5} ${l - 5}Z" fill="#C5CCD0"/></svg></div>`),
          (document.querySelector(
    ...
    function N(e, t, l, n) {
      t < 0
        ? ((document.querySelector(`.arrowid[value="${n.id}"]`).parentNode.style.left = `${
            e.x - 5 - (u + window.scrollX) + s.getBoundingClientRect().left
          }px`),
          (document.querySelector(`.arrowid[value="${n.id}"]`).parentNode.innerHTML =
            `<input type="hidden" class="arrowid" value="${
              n.id
            }"><svg preserveaspectratio="none" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M${
              i.filter(e => e.id == n.parent)[0].x - e.x + 5
            } 0L${i.filter(e => e.id == n.parent)[0].x - e.x + 5} ${B / 2}L5 ${
              B / 2
            }L5 ${l}" stroke="#C5CCD0" stroke-width="2px"/><path d="M0 ${l - 5}H10L5 ${l}L0 ${
              l - 5
            }Z" fill="#C5CCD0"/></svg>`))
        : ((document.querySelector(`.arrowid[value="${n.id}"]`).parentNode.style.left = `${
          ...
          (document.querySelector(`.arrowid[value="${n.id}"]`).parentNode.innerHTML =
            `<input type="hidden" class="arrowid" value="${
              ...
              t + 5
            }L${t} ${l}L${t - 5} ${l - 5}Z" fill="#C5CCD0"/></svg>`))
    }
    function T(e, t, l) {
      R || s.appendChild(e)
      ...
      for (d = 0; d < i.filter(e => e.parent == l[t]).length; d++) {
        ;(f = i.filter(e => e.parent == l[t])[d]).childwidth > f.width
          ? ((document.querySelector(`.blockid[value='${f.id}']`).parentNode.style.left = `${
              i.filter(e => e.id == l[t])[0].x - o / 2 + r + f.childwidth / 2 - f.width / 2
            }px`),
            (f.x = i.filter(e => e.parent == l[t])[0].x - o / 2 + r + f.childwidth / 2),
            (r += f.childwidth + m))
          : ((document.querySelector(`.blockid[value='${f.id}']`).parentNode.style.left = `${
              i.filter(e => e.id == l[t])[0].x - o / 2 + r
            }px`),
            (f.x = i.filter(e => e.parent == l[t])[0].x - o / 2 + r + f.width / 2),
            (r += f.width + m))
      }
      if (
        ((e.style.left = `${
        ...
        ;((n.filter(t => t.id == parseInt(e.querySelector('.blockid').value))[0].x =
          ...
          s.scrollLeft -
          s.getBoundingClientRect().left),
          (n.filter(t => t.id == parseInt(e.querySelector('.blockid').value))[0].y =
            e.getBoundingClientRect().top +
            window.scrollY +
            parseInt(window.getComputedStyle(e).height) / 2 +
            s.scrollTop -
            s.getBoundingClientRect().top),
          (n.filter(t => t.id == e.querySelector('.blockid').value)[0].parent = l[t]))
        for (d = 0; d < n.length; d++)
          if (n[d].id != parseInt(e.querySelector('.blockid').value)) {
            const e = document.querySelector(`.blockid[value='${n[d].id}']`).parentNode
            const t = document.querySelector(`.arrowid[value='${n[d].id}']`).parentNode
            ;((e.style.left = `${
              e.getBoundingClientRect().left +
              window.scrollX -
      ...
      const c = i.filter(t => t.id == parseInt(e.querySelector('.blockid').value))[0]
      if (
        (I(c, c.x - i.filter(e => e.id == l[t])[0].x + 20, B, l[t]),
        i.filter(e => e.id == l[t])[0].parent != -1)
      ) {
        for (var a = !1, g = l[t]; !a; )
          if (i.filter(e => e.id == g)[0].parent == -1) a = !0
          else {
            let w = 0
    ...
    function M(e, t) {
      return (
        !!(e.className && e.className.split(' ').indexOf(t) >= 0) || (e.parentNode && M(e.parentNode, t))
      )
    }
    function E() {
      x = i.map(e => e.x)
      ...
      if ((x = Math.min.apply(Math, t)) < s.getBoundingClientRect().left + window.scrollX - u) {
        for (var l = i.map(e => e.id), n = 0; n < i.length; n++)
          if (
            ...
            const r = o.x - i.filter(e => e.id == i.filter(e => e.id == l[n])[0].parent)[0].x
            document.querySelector(`.arrowid[value="${l[n]}"]`).parentNode.style.left =
              r < 0
                ? `${o.x - x + 20 - 5 + s.getBoundingClientRect().left - u}px`
                : `${
                    i.filter(e => e.id == i.filter(e => e.id == l[n])[0].parent)[0].x -
                    20 -
                    x +
                    s.getBoundingClientRect().left -
                    u +
        ...
        for (n = 0; n < i.length; n++)
          i[n].x =
            document.querySelector(`.blockid[value='${i[n].id}']`).parentNode.getBoundingClientRect()
              .left +
            window.scrollX +
            s.scrollLeft +
            parseInt(
              window.getComputedStyle(document.querySelector(`.blockid[value='${i[n].id}']`).parentNode)
                .width,
              10
            ) /
              2 -
          ...
          ;((c.style.top = `${a.y + B + s.getBoundingClientRect().top - p}px`),
            ...
            r.childwidth > r.width
              ? ((c.style.left = `${
                ...
                (n += r.childwidth + m))
              : ((c.style.left = `${
                  a[0].x - l / 2 + n - (u + window.scrollX) + s.getBoundingClientRect().left
                }px`),
