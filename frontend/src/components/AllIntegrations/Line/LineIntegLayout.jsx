...
const recipientIdNote = `<h2>${__('To get your Line Recipient ID:', 'bit-integrations')}</h2>
  <ul>
    <li>${__(
      'From Line Developers Console go to the Messaging API tab. Your User ID is listed under the Webhook URL section.',
      'bit-integrations'
    )}</li>
    <li>${__(
      'The User ID is included in the webhook event data every time a user sends a message to your bot.',
      'bit-integrations'
    )}</li>
</ul>`
...
const replyTokenNote = `<h2>${__('To get your Line Reply Token:', 'bit-integrations')}</h2>
    <ul>
        <li>${__(
          'From Line Developers Console go to the Messaging API tab. Your Reply Token is listed under the Webhook URL section.',
          'bit-integrations'
        )}</li>
    <li>${__(
      'The Reply Token is included in the webhook event data every time a user sends a message to your bot.',
      'bit-integrations'
    )}</li>
    </ul>`
...
const emojiNote = `<h2>${__('To get Line Emoji IDs and Product IDs:', 'bit-integrations')}</h2>
    <ul>
        <li>${__(
          'For more information visit the <a href="https://developers.line.biz/en/docs/messaging-api/emoji-list/" target="_blank">Line Emoji List</a> documentation.',
          'bit-integrations'
        )}</li>
    </ul>`
...
const stickerNote = `<h2>${__('To get Line Sticker IDs and Package IDs:', 'bit-integrations')}</h2>
    <ul>
        <li>${__(
          'For more information visit the <a href="https://developers.line.biz/en/docs/messaging-api/sticker-list/" target="_blank">Line Sticker List</a> documentation.',
          'bit-integrations'
        )}</li>
    </ul>`
...
const imageNote = `<h2>${__('To set up LINE Image Messages:', 'bit-integrations')}</h2>
    <ul>
        ...
        <li>${__(
          'Preview Image URL: Direct HTTPS link to a smaller preview image.',
          'bit-integrations'
        )}</li>
...
const audioNote = `<h2>${__('To set up LINE Audio Messages:', 'bit-integrations')}</h2>
    <ul>
        ...
        <li>${__(
          'Duration: Length of the audio in milliseconds (e.g., 60000 for 1 minute).',
          'bit-integrations'
        )}</li>
...
const videoNote = `<h2>${__('To set up LINE Video Messages:', 'bit-integrations')}</h2>
    <ul>
        ...
        <li>${__(
          'Preview Image URL: Direct HTTPS link to the video thumbnail.',
          'bit-integrations'
        )}</li>
