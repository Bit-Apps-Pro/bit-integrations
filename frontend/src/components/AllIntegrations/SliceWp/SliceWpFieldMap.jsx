      ...
      <div className="pos-rel flx">
        <div className="flx integ-fld-wrp">
          <select
            ...
            onChange={ev => handleFieldMapping(ev, i, sliceWpConf, setSliceWpConf)}>
          ...
          {field.formField === 'custom' && (
            <TagifyInput
              onChange={e => handleCustomValue(e, i, sliceWpConf, setSliceWpConf)}
          ...
          <select
            ...
            name="slicewpFormField"
            value={i < requiredFlds.length ? requiredFlds[i].key || '' : field.slicewpFormField || ''}
            onChange={ev => handleFieldMapping(ev, i, sliceWpConf, setSliceWpConf)}>
            <option value="">{__('Select Field', 'bit-integrations')}</option>
        ...
        {i >= requiredFlds.length && (
          <>
            ...
            <button
              onClick={() => delFieldMap(i, sliceWpConf, setSliceWpConf)}
