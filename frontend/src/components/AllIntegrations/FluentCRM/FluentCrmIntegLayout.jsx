...
export default function FluentCrmIntegLayout({
  ...
  return (
    <>
      ...
      {fluentCrmConf?.actionName &&
        fluentCrmConf?.actionName !== 'remove-user' &&
        ...
        !loading.fluentCrmTags && (
          <div className="flx mt-5">
            ...
            <MultiSelect
              ...
              options={
                fluentCrmConf?.fluentCrmTags &&
                Object.keys(fluentCrmConf.fluentCrmTags).map(tag => ({
                  label: fluentCrmConf.fluentCrmTags[tag].title,
                  value: fluentCrmConf.fluentCrmTags[tag].id.toString()
                }))
              }
      ...
      {fluentCrmConf?.actionName && !isLoading && (
        <>
          ...
          <div className="flx flx-around mt-2 mb-2 btcbi-field-map-label">
            ...
            <div className="txt-dp">
              <b>{__('Fluent CRM Fields', 'bit-integrations')}</b>
            </div>
          </div>
