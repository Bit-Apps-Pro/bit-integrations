...
export default function OneHashCRMIntegLayout({
  formFields,
  handleInput,
  oneHashCRMConf,
  setOneHashCRMConf,
      ...
      {oneHashCRMConf.actionName === 'lead' && (
        <>
          ...
          <div className="flx">
            ...
            <MultiSelect
              options={oneHashCRMConf?.leadStatus.map(status => ({
                label: status,
                value: status
              }))}
      ...
      {oneHashCRMConf.actionName && !isLoading && (
        <div>
          ...
          <div className="flx flx-around mt-2 mb-2 btcbi-field-map-label">
            ...
            <div className="txt-dp">
              <b>{__('OneHashCRM Fields', 'bit-integrations')}</b>
            </div>
          </div>
