...
export default function BenchMarkIntegLayout({
  formFields,
  benchMarkConf,
  setBenchMarkConf,
  isLoading,
  ...
  return (
    <>
      ...
      <div className="mt-4">
        ...
        <button
          onClick={() =>
            refreshBenchMarkHeader(benchMarkConf, setBenchMarkConf, setIsLoading, setSnackbar)
          }
          className="icn-btn sh-sm ml-2 mr-2 tooltip"
      ...
      {(benchMarkConf?.listId || benchMarkConf?.default?.fields) && (
        <>
          ...
          <div className="flx flx-around mt-2 mb-2 btcbi-field-map-label">
            ...
            <div className="txt-dp">
              <b>{__('BenchMark Fields', 'bit-integrations')}</b>
            </div>
          </div>
