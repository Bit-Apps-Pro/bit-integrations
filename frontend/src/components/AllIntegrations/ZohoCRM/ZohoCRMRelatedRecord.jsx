...
export default function ZohoCRMRelatedRecord({
  ...
  return (
    <>
      ...
      <br />
      {crmConf.default?.layouts?.[crmConf?.relatedlists?.[tab - 1]?.module]?.[
        crmConf?.relatedlists?.[tab - 1]?.layout
      ]?.fields && (
        <>
          <div className="mt-4">
          ...
          <div className="txt-center btcbi-field-map-button mt-2">
            <button
              onClick={() =>
                addFieldMap(
                  crmConf.relatedlists[tab - 1].field_map.length,
                  crmConf,
                  setCrmConf,
                  false,
                  tab
          ...
          {crmConf.default?.layouts[crmConf.relatedlists[tab - 1].module]?.[
            ...
            Object.keys(
              ...
              <>
                <div className="mt-4">
                  <b className="wdt-100">{__('File Upload Field Map', 'bit-integrations')}</b>
                </div>
                <div className="btcd-hr mt-1" />
                <div className="flx flx-around mt-2 mb-2 btcbi-field-map-label">
                  <div className="txt-dp">
                ...
                <div className="txt-center btcbi-field-map-button mt-2">
                  <button
                    onClick={() =>
                      addFieldMap(
                        crmConf.relatedlists[tab - 1].upload_field_map.length,
                        crmConf,
                        setCrmConf,
                        true,
                        tab
