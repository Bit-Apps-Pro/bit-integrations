...
export default function DemioFieldMap({
  i,
  formFields,
  field,
  licenseManagerConf,
  ...
  const requiredFields =
    (licenseManagerConf?.lmfwcFields &&
      licenseManagerConf.lmfwcFields.filter(fld => fld.required === true)) ||
    []
  const allNonRequiredFields =
    (licenseManagerConf?.lmfwcFields &&
      licenseManagerConf.lmfwcFields.filter(fld => fld.required === false)) ||
    []
      ...
      <div className="pos-rel flx">
        <div className="flx integ-fld-wrp">
          ...
          <select
            ...
            name="lmfwcFormField"
            value={i < requiredFields.length ? requiredFields[i].key || '' : field.lmfwcFormField || ''}
            onChange={ev => handleFieldMapping(ev, i, licenseManagerConf, setLicenseManagerConf)}>
            <option value="">{__('Select Field', 'bit-integrations')}</option>
