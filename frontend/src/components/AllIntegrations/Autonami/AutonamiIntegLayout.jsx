    ...
    <>
      ...
      <div className="flx">
        ...
        <MultiSelect
          ...
          options={
            autonamiConf?.default?.autonamiList &&
            Object.keys(autonamiConf.default.autonamiList).map(list => ({
              label: autonamiConf.default.autonamiList[list].title,
              value: autonamiConf.default.autonamiList[list].id.toString()
            }))
          }
        ...
        <button
          onClick={() =>
            refreshAutonamiListsAndTags(autonamiConf, setAutonamiConf, setIsLoading, setSnackbar)
          }
      ...
      <div className="flx mt-5">
        ...
        <MultiSelect
          ...
          className="btcd-paper-drpdwn w-5"
          options={
            autonamiConf?.default?.autonamiTags &&
            Object.keys(autonamiConf.default.autonamiTags).map(tag => ({
              label: autonamiConf.default.autonamiTags[tag].title,
              value: autonamiConf.default.autonamiTags[tag].id.toString()
            }))
          }
      ...
      <div className="mt-4">
        ...
        <button
          onClick={() =>
            getAutonamiFields(autonamiConf, setAutonamiConf, setIsLoading, setSnackbar, true)
          }
          className="icn-btn sh-sm ml-2 mr-2 tooltip"
      ...
      <div className="flx flx-around mt-2 mb-2 btcbi-field-map-label">
        ...
        <div className="txt-dp">
          <b>{__('Autonami Fields', 'bit-integrations')}</b>
        </div>
      </div>
      ...
      <div className="btcd-hr mt-1" />
      <AutonamiActions autonamiConf={autonamiConf} setAutonamiConf={setAutonamiConf} />
    </>
  )
}
