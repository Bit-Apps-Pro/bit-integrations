      ...
      <div className="pos-rel flx">
        <div className="flx integ-fld-wrp">
          <select
            ...
            onChange={ev => handleFieldMapping(ev, i, wpDataTablesConf, setWpDataTablesConf)}>
          ...
          {field.formField === 'custom' && (
            <TagifyInput
              onChange={e => handleCustomValue(e, i, wpDataTablesConf, setWpDataTablesConf)}
          ...
          <select
            ...
            name="wpDataTablesField"
            value={i < requiredFlds.length ? requiredFlds[i].key || '' : field.wpDataTablesField || ''}
            onChange={ev => handleFieldMapping(ev, i, wpDataTablesConf, setWpDataTablesConf)}>
            <option value="">{__('Select Field', 'bit-integrations')}</option>
        ...
        {i >= requiredFlds.length && (
          <>
            <button
              onClick={() => addFieldMap(i, wpDataTablesConf, setWpDataTablesConf)}
