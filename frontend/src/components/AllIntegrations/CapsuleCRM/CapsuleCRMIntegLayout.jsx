...
export default function CapsuleCRMIntegLayout({
  formFields,
  handleInput,
  capsulecrmConf,
  setCapsuleCRMConf,
  ...
  const handleActionInput = e => {
    ...
    newConf.field_map = [{ formField: '', capsulecrmFormField: '' }]
    const { name } = e.target
    if (e.target.value !== '') {
      ...
      {(capsulecrmConf.actionName === 'opportunity' || capsulecrmConf.actionName === 'project') && (
        <>
          ...
          <div className="flx">
            ...
            <MultiSelect
              options={capsulecrmConf?.CRMParties?.map(CRMParty => ({
                label: CRMParty.name,
                value: CRMParty.id
              }))}
      ...
      {capsulecrmConf.actionName === 'opportunity' && capsulecrmConf.selectedCRMParty && (
        <>
          ...
          <div className="flx">
            ...
            <MultiSelect
              options={capsulecrmConf?.CRMMilestones?.map(CRMMilestone => ({
                label: CRMMilestone.name,
                value: CRMMilestone.id
              }))}
              className="msl-wrp-options dropdown-custom-width"
      ...
      {capsulecrmConf.actionName && !loading.customFields && (
        <div>
          ...
          <div className="flx flx-around mt-2 mb-2 btcbi-field-map-label">
            ...
            <div className="txt-dp">
              <b>{__('CapsuleCRM Fields', 'bit-integrations')}</b>
            </div>
          </div>
