...
export default function GoogleContactsFieldMap({
  i,
  formFields,
  field,
  googleContactsConf,
      ...
      <div className="pos-rel flx">
        <div className="flx integ-fld-wrp">
          <select
            ...
            onChange={ev => handleFieldMapping(ev, i, googleContactsConf, setGoogleContactsConf)}>
          ...
          {field.formField === 'custom' && (
            <TagifyInput
              onChange={e => handleCustomValue(e, i, googleContactsConf, setGoogleContactsConf)}
          ...
          <select
            ...
            name="googleContactsFormField"
            value={
              i < requiredFlds.length ? requiredFlds[i].key || '' : field.googleContactsFormField || ''
            }
            onChange={ev => handleFieldMapping(ev, i, googleContactsConf, setGoogleContactsConf)}>
            <option value="">{__('Select Field', 'bit-integrations')}</option>
        ...
        {i >= requiredFlds.length && (
          <>
            ...
            <button
              onClick={() => delFieldMap(i, googleContactsConf, setGoogleContactsConf)}
