    ...
    <>
      ...
      <div className="flx">
        ...
        <input
          ...
          type="text"
          placeholder={__('tag-1, tag-2', 'bit-integrations')}
        />
        <Cooltip width={250} icnSize={17} className="ml-2">
          <div className="txt-body">{__('Tags separate with comma', 'bit-integrations')}</div>
        </Cooltip>
      </div>
      {enchargeConf?.default?.fields !== 0 && (
        <>
          ...
          <div className="flx flx-around mt-2 mb-2 btcbi-field-map-label">
            ...
            <div className="txt-dp">
              <b>{__('Encharge Fields', 'bit-integrations')}</b>
            </div>
          </div>
