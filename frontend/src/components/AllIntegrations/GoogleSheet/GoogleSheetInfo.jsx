  ...
  return (
    <div style={{ width: '900px' }}>
      {sheetConf.tokenDetails.selectedAuthType == 'Custom Authorization' && (
        <div>
          <h3>
            Account Details <small>(Custom Authorization)</small>{' '}
          </h3>
          <div className="mt-3">
      ...
      {sheetConf.tokenDetails.selectedAuthType == 'One Click Authorization' && authData.length !== 0 && (
        <div>
          <h3>
            Account Details <small>(One Click Authorization)</small>{' '}
          </h3>
          <AuthorizationAccountList authData={authData} isInfo={isInfo} />
        </div>
      )}
      {sheetConf.tokenDetails.selectedAuthType == 'One Click Authorization' && authData.length === 0 && (
        <div>
          <h3>
            The Authorized Account Has been Deleted. <small>(One Click Authorization)</small>{' '}
          </h3>
        </div>
      )}
    </div>
