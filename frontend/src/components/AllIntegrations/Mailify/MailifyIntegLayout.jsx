...
export default function MailifyIntegLayout({
  formFields,
  mailifyConf,
  setMailifyConf,
  isLoading,
  ...
  return (
    <>
      ...
      <button
        onClick={() => refreshMailifyList(mailifyConf, setMailifyConf, setIsLoading, setSnackbar)}
        ...
        <>
          ...
          <div className="flx flx-around mt-2 mb-2 btcbi-field-map-label">
            <div className="txt-dp">
              <b>{__('List Fields', 'bit-integrations')}</b>
            </div>
            <div className="txt-dp">
              <b>{__('Mailify Fields', 'bit-integrations')}</b>
            </div>
          </div>
          ...
          <div className="btcd-hr mt-1" />
          <MailifyActions mailifyConf={mailifyConf} setMailifyConf={setMailifyConf} />
        </>
      )}
    </>
  )
