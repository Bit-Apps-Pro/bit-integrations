...
export default function ActiveCampaignFieldMap({
  i,
  formFields,
  field,
  activeCampaingConf,
  ...
  const notResquiredField =
    ...
    Object.values(activeCampaingConf?.default?.fields).filter(f => !f.required)
    ...
    <div className="flx mt-2 mb-2 btcbi-field-map">
      <div className="flx integ-fld-wrp">
        ...
        {field.formField === 'custom' && (
          <TagifyInput
            onChange={e => handleCustomValue(e, i, activeCampaingConf, setActiveCampaingConf)}
        ...
        <select
          ...
          {isRequired
            ? activeCampaingConf?.default?.fields &&
              Object.values(activeCampaingConf.default.fields).map(fld => (
