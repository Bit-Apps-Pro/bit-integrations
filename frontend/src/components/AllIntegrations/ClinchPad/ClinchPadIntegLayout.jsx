...
export default function ClinchPadIntegLayout({
  formFields,
  handleInput,
  clinchPadConf,
  setClinchPadConf,
  ...
  const handleActionInput = e => {
    ...
    newConf.field_map = [{ formField: '', clinchPadFormField: '' }]
    const { name } = e.target
    if (e.target.value !== '') {
      ...
      {clinchPadConf.actionName === 'lead' && (
        <>
          ...
          <div className="flx">
            ...
            <MultiSelect
              options={clinchPadConf?.CRMPipelines?.map(CRMPipeline => ({
      ...
      {clinchPadConf.actionName && (
        <div>
          ...
          <div className="flx flx-around mt-2 mb-2 btcbi-field-map-label">
            ...
            <div className="txt-dp">
              <b>{__('ClinchPad Fields', 'bit-integrations')}</b>
            </div>
          </div>
