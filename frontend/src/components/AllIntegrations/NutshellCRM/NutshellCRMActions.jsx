...
import {
  ...
  getAllSources,
  getAllTags
} from './NutshellCRMCommonFunc'
import Loader from '../../Loaders/Loader'

export default function NutshellCRMActions({
  nutshellCRMConf,
  setNutshellCRMConf,
  loading,
  setLoading
  ...
  return (
    <div className="pos-rel d-flx flx-wrp">
      {nutshellCRMConf.actionName === 'lead' && (
        <TableCheckBox
          checked={nutshellCRMConf.actions?.Priority || false}
          onChange={e => actionHandler(e, 'priority')}
          className="wdt-200 mt-4 mr-2"
          value="priority"
          title={__('Priority', 'bit-integrations')}
          subTitle={__('Priority', 'bit-integrations')}
        />
      )}
      {(nutshellCRMConf.actionName === 'lead' || nutshellCRMConf.actionName === 'people') && (
        <TableCheckBox
          checked={nutshellCRMConf?.selectedCompany || false}
      ...
      {nutshellCRMConf.actionName === 'lead' && (
        <TableCheckBox
          checked={nutshellCRMConf?.selectedProduct || false}
          onChange={e => actionHandler(e, 'Product')}
          className="wdt-200 mt-4 mr-2"
          value="Product"
          title={__('Add Product', 'bit - integrations')}
          subTitle={__('Add Product')}
        />
      )}
      {nutshellCRMConf.actionName === 'lead' && (
        <TableCheckBox
          checked={nutshellCRMConf?.selectedSource || false}
      ...
      {nutshellCRMConf.actionName === 'lead' && (
        <TableCheckBox
          checked={nutshellCRMConf?.selectedTag || false}
      ...
      {(nutshellCRMConf.actionName === 'company' || nutshellCRMConf.actionName === 'lead') && (
        <TableCheckBox
          checked={nutshellCRMConf?.selectedContact || false}
      ...
      {nutshellCRMConf.actionName === 'company' && (
        <TableCheckBox
          checked={nutshellCRMConf?.selectedCompanyType || false}
          onChange={e => actionHandler(e, 'CompanyType')}
          className="wdt-200 mt-4 mr-2"
          value="CompanyType"
          title={__('Add CompanyType', 'bit - integrations')}
          subTitle={__('Add CompanyType')}
        />
      )}
      ...
      <ConfirmModal
        ...
        {loading.companies ? (
          ...
          <div className="flx flx-between mt-2">
            <MultiSelect
              options={nutshellCRMConf?.companies?.map(company => ({
                label: company.name,
                value: company.id
              }))}
      ...
      <ConfirmModal
        ...
        {loading.contacts ? (
          ...
          <div className="flx flx-between mt-2">
            <MultiSelect
              options={nutshellCRMConf?.contacts?.map(contact => ({
                label: contact.name,
                value: contact.id
              }))}
              className="msl-wrp-options"
      ...
      <ConfirmModal
        ...
        {loading.products ? (
          ...
          <div className="flx flx-between mt-2">
            <MultiSelect
              options={nutshellCRMConf?.products?.map(product => ({
                label: product.name,
                value: product.id
              }))}
              className="msl-wrp-options"
      ...
      <ConfirmModal
        ...
        {loading.sources ? (
          ...
          <div className="flx flx-between mt-2">
            <MultiSelect
              options={nutshellCRMConf?.sources?.map(source => ({
                label: source.name,
                value: source.id
              }))}
              className="msl-wrp-options"
      ...
      <ConfirmModal
        ...
        {loading.companyTypes ? (
          ...
          <div className="flx flx-between mt-2">
            <MultiSelect
              options={nutshellCRMConf?.companyTypes?.map(companyType => ({
