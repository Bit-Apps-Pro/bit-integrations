      ...
      <div className="pos-rel flx">
        <div className="flx integ-fld-wrp">
          <select
            ...
            onChange={ev => handleFieldMapping(ev, i, giveWpConf, setGiveWpConf)}>
          ...
          {field.formField === 'custom' && (
            <TagifyInput
              onChange={e => handleCustomValue(e, i, giveWpConf, setGiveWpConf)}
          ...
          <select
            ...
            name="giveWpFormField"
            value={i < requiredFlds.length ? requiredFlds[i].key || '' : field.giveWpFormField || ''}
            onChange={ev => handleFieldMapping(ev, i, giveWpConf, setGiveWpConf)}>
            <option value="">{__('Select Field', 'bit-integrations')}</option>
        ...
        {i >= requiredFlds.length && (
          <>
            ...
            <button
              onClick={() => delFieldMap(i, giveWpConf, setGiveWpConf)}
