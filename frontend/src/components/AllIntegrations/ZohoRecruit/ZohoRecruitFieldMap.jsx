...
export default function ZohoRecruitFieldMap({
  ...
  if (uploadFields) {
    isNotRequired =
      field.zohoFormField === '' ||
      recruitConf.default.moduleData?.[module]?.requiredFileUploadFields?.indexOf(
        field.zohoFormField
      ) === -1
  } else {
    isNotRequired =
      field.zohoFormField === '' ||
      recruitConf.default.moduleData?.[module]?.required?.indexOf(field.zohoFormField) === -1
  }
    ...
    <div className="flx mt-2 mb-2 btcbi-field-map">
      <div className="flx integ-fld-wrp">
        ...
        {field.formField === 'custom' && (
          <TagifyInput
            onChange={e => handleCustomValue(e, i, recruitConf, setRecruitConf)}
