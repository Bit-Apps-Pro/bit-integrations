    ...
    <>
      ...
      <select
        ...
        {recruitConf?.default.relatedlists?.[recruitConf.module] &&
          Object.values(recruitConf.default.relatedlists[recruitConf.module]).map(relatedlistApiName => (
      ...
      {recruitConf.default?.moduleData?.[recruitConf.relatedlists?.[tab - 1]?.module]?.fields && (
        <>
          ...
          <div className="flx flx-around mt-2 mb-2 btcbi-field-map-label">
            ...
            <div className="txt-dp">
              <b>{__('Zoho Fields', 'bit-integrations')}</b>
            </div>
          </div>
          ...
          <div className="txt-center btcbi-field-map-button mt-2">
            <button
              onClick={() =>
                addFieldMap(
                  recruitConf.relatedlists[tab - 1].field_map.length,
                  recruitConf,
                  setRecruitConf,
                  false,
                  tab
            ...
            <>
              ...
              <div className="txt-center btcbi-field-map-button mt-2">
                <button
                  onClick={() =>
                    addFieldMap(
                      recruitConf.relatedlists[tab - 1].upload_field_map.length,
                      recruitConf,
                      setRecruitConf,
                      true,
                      tab
          ...
          <ZohoRecruitActions recruitConf={recruitConf} setRecruitConf={setRecruitConf} tab={tab} />
        </>
      )}
    </>
  )
