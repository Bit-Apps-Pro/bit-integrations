...
import {
  ...
  delContactFieldMap,
  delFieldMap,
  handleContactFieldMapping,
  handleCustomValue,
  handleFieldMapping
} from './FreshdeskIntegrationHelpers'
import { SmartTagField } from '../../../Utils/StaticData/SmartTagField'
import { $appConfigState } from '../../../GlobalStates'
import { generateContactMappedField } from './FreshdeskCommonFunc'

export default function FreshdeskContactFieldMap({
  i,
  formFields,
  field,
  freshdeskConf,
  ...
  const requiredFlds =
    (freshdeskConf?.contactFields &&
      freshdeskConf?.contactFields?.filter(fld => fld.required === true)) ||
    []
  const nonRequiredFlds =
    (freshdeskConf?.contactFields &&
      freshdeskConf?.contactFields?.filter(fld => fld.required === false)) ||
    []
