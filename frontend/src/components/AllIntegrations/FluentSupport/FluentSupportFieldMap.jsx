...
import { generateMappedField } from './FluentSupportCommonFunc'
import TagifyInput from '../../Utilities/TagifyInput'
import { handleCustomValue } from '../IntegrationHelpers/IntegrationHelpers'

export default function FluentSupportFieldMap({
  i,
  formFields,
  field,
  fluentSupportConf,
  ...
  const nonRequiredFlds =
    fluentSupportConf?.fluentSupportFields.filter(fld => fld.required === false) || []
      ...
      <div className="pos-rel flx">
        <div className="flx integ-fld-wrp">
          ...
          {field.formField === 'custom' && (
            <TagifyInput
              onChange={e => handleCustomValue(e, i, fluentSupportConf, setFluentSupportConf)}
