...
export default function WoodpeckerIntegLayout({
  formFields,
  handleInput,
  woodpeckerConf,
  setWoodpeckerConf,
    ...
    setWoodpeckerConf(prevConf =>
      create(prevConf, draftConf => {
        ...
        if (e.target.value !== '') {
          ...
          if (
            draftConf.actionName === 'adding_prospects_to_the_prospects_list' ||
            draftConf.actionName === 'adding_prospects_to_the_campaign'
          ) {
        ...
        !loading.campaign && (
          <>
            ...
            <div className="flx">
              ...
              <MultiSelect
                options={woodpeckerConf?.campaigns.map(campaign => ({
                  label: campaign.name,
      ...
      {woodpeckerConf.actionName && !isLoading && (
        <div>
          ...
          <div className="flx flx-around mt-2 mb-2 btcbi-field-map-label">
            ...
            <div className="txt-dp">
              <b>{__('Woodpecker Fields', 'bit-integrations')}</b>
            </div>
          </div>
