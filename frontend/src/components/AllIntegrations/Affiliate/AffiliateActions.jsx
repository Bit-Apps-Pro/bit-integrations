...
export default function AffiliateActions({ affiliateConf, setAffiliateConf, formFields }) {
  ...
  return (
    <div className="pos-rel d-flx w-8">
      <TableCheckBox
        checked={affiliateConf?.actions?.status || false}
        ...
        {isLoading ? (
          ...
          <div className="flx flx-between mt-2">
            <MultiSelect
              ...
              options={affiliateConf?.allStatus.map(item => ({
                label: item.label,
                value: item.key
              }))}
      ...
      <TableCheckBox
        checked={affiliateConf?.actions?.type || false}
        ...
        {isLoading ? (
          ...
          <div className="flx flx-between mt-2">
            <MultiSelect
              ...
              options={affiliateConf.allReferralType.map(item => ({
                label: item.label,
                value: item.key
              }))}
