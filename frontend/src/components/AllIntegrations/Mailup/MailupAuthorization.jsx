...
export default function MailupAuthorization({
  ...
  return (
    <div
      ...
      {mailup?.youTubeLink && <TutorialLink title="MailUp" youTubeLink={mailup?.youTubeLink} />}
      {mailup?.docLink && <TutorialLink title="MailUp" docLink={mailup?.docLink} />}
