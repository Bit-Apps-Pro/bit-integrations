...
export default function DemioIntegLayout({
  formFields,
  demioConf,
  setDemioConf,
  loading,
        ...
        <>
          ...
          <div className="flx">
            ...
            <MultiSelect
              options={
                demioConf?.events &&
                demioConf.events.map(event => ({ label: event.name, value: `${event.id}` }))
              }
        ...
        <>
          ...
          <div className="flx">
            ...
            <MultiSelect
              options={
                demioConf?.sessions &&
                demioConf.sessions.map(session => ({
      ...
      {demioConf.actionName && !isLoading && (
        <div>
          ...
          <div className="flx flx-around mt-2 mb-2 btcbi-field-map-label">
            ...
            <div className="txt-dp">
              <b>{__('Demio Fields', 'bit-integrations')}</b>
            </div>
          </div>
