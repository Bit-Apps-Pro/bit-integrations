...
export default function SuiteDashIntegLayout({
  formFields,
  suiteDashConf,
  setSuiteDashConf,
  loading,
  ...
  return (
    <>
      ...
      <select
        ...
        name="actionName"
        value={suiteDashConf.actionName}
      ...
      {suiteDashConf.actionName && !isLoading && (
        <div>
          ...
          <div className="flx flx-around mt-2 mb-2 btcbi-field-map-label">
            ...
            <div className="txt-dp">
              <b>{__('SuiteDash Fields', 'bit-integrations')}</b>
            </div>
          </div>
          ...
          <div className="txt-center btcbi-field-map-button mt-2">
            <button
              onClick={() =>
                addFieldMap(suiteDashConf.field_map.length, suiteDashConf, setSuiteDashConf, false)
              }
