    ...
    <div className="pos-rel">
      <div className="d-flx flx-wrp">
        <TableCheckBox
          ...
          checked={'attachments' in slackConf.actions}
          className="wdt-200 mt-4 mr-2"
          value="Attachment"
          title={__('Attachments', 'bit-integrations')}
          subTitle={__('Add attachments from Bit Integrations to send Slack.', 'bit-integrations')}
        />
      </div>
      ...
      <ConfirmModal
        ...
        <select
          ...
          name="attachments"
          value={slackConf.actions?.attachments}
