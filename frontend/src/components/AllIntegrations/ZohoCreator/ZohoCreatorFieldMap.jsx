...
export default function ZohoCreatorFieldMap({
  i,
  formFields,
  uploadFields,
  field,
  ...
  if (uploadFields)
    isNotRequired =
      field.zohoFormField === '' ||
      creatorConf.default?.fields?.[applicationId]?.[formId]?.requiredFileUploadFields?.indexOf(
        field.zohoFormField
      ) === -1
  else
    isNotRequired =
    ...
    <div className="flx mt-2 mb-2 btcbi-field-map">
      <div className="flx integ-fld-wrp">
        ...
        {field.formField === 'custom' && (
          <TagifyInput
            onChange={e => handleCustomValue(e, i, creatorConf, setCreatorConf)}
        ...
        <select
          ...
          {uploadFields
            ? creatorConf.default?.fields?.[applicationId]?.[formId]?.fileUploadFields &&
              Object.values(creatorConf.default.fields[applicationId][formId].fileUploadFields).map(
                apiField =>
                  isNotRequired ? (
