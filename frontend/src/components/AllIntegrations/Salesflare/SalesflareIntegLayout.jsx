...
export default function SalesflareIntegLayout({
  formFields,
  handleInput,
  salesflareConf,
  setSalesflareConf,
  ...
  return (
    <>
      ...
      <select
        ...
        <option value="contacts" data-action_name="contacts">
          {__('Create Contact', 'bit-integrations')}
        </option>
        <option value="opportunities" data-action_name="opportunities">
      ...
      {salesflareConf.actionName === 'opportunities' && salesflareConf?.accounts && (
        <>
          ...
          <div className="flx">
            ...
            <MultiSelect
              options={salesflareConf?.accounts.map(account => ({
                label: account.name,
      ...
      {salesflareConf.actionName === 'opportunities' && salesflareConf?.pipelines && (
        <>
          ...
          <div className="flx">
            ...
            <MultiSelect
              options={salesflareConf?.pipelines.map(pipeline => ({
                label: pipeline.name,
      ...
      {salesflareConf.actionName === 'opportunities' && salesflareConf?.stages && (
        <>
          ...
          <div className="flx">
            ...
            <MultiSelect
              options={salesflareConf?.stages.map(stage => ({
                label: stage.name,
      ...
      {salesflareConf.actionName && !isLoading && (
        <div>
          ...
          <div className="flx flx-around mt-2 mb-2 btcbi-field-map-label">
            ...
            <div className="txt-dp">
              <b>{__('Salesflare Fields', 'bit-integrations')}</b>
            </div>
          </div>
