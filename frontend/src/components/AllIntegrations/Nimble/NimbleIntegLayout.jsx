...
export default function NimbleIntegLayout({
  formFields,
  nimbleConf,
  setNimbleConf,
  loading,
    ...
    setNimbleConf(prevConf => {
      ...
      if (e.target.value !== '') {
        ...
        newConf.field_map = generateMappedField(
          e.target.value === 'person' ? newConf?.peopleFields : newConf?.companyFields
        )
      } else {
      ...
      {!loading.allFields && (
        <>
          ...
          <select
            ...
            <option value="company" data-action_name="project">
      ...
      {nimbleConf.actionName && !isLoading && !loading.allFields && (
        <div>
          ...
          <div className="flx flx-around mt-2 mb-2 btcbi-field-map-label">
            ...
            <div className="txt-dp">
              <b>{__('Nimble Fields', 'bit-integrations')}</b>
            </div>
          </div>
