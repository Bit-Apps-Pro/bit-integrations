...
export default function MailjetIntegLayout({
  formFields,
  mailjetConf,
  setMailjetConf,
  loading,
    ...
    <>
      ...
      <div>
        ...
        <div className="flx flx-around mt-2 mb-2 btcbi-field-map-label">
          ...
          <div className="txt-dp">
            <b>{__('Mailjet Fields', 'bit-integrations')}</b>
          </div>
        </div>

        {mailjetConf?.selectedLists &&
          mailjetConf?.field_map.map((itm, i) => (
            <MailjetFieldMap
              key={`rp-m-${i + 9}`}
              i={i}
              field={itm}
        ...
        {mailjetConf?.selectedLists && (
          <div>
            ...
            <div className="btcd-hr mt-1" />
            <MailjetActions mailjetConf={mailjetConf} setMailjetConf={setMailjetConf} />
          </div>
        )}
      </div>
    </>
