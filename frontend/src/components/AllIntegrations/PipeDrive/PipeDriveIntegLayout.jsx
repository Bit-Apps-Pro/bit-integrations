...
export default function PipeDriveIntegLayout({
  tab,
  settab,
  formID,
  formFields,
      ...
      <div>
        <Tabs>
          <div className="flx mt-2">
            ...
            {pipeDriveConf?.relatedlists &&
              pipeDriveConf.relatedlists.map((_, indx) => (
                <>
                  <Tab key={`t-${indx * 3}`}>
                    <button
            ...
            {pipeDriveConf.relatedlists.length < 2 &&
              pipeDriveConf.default.modules[pipeDriveConf.moduleData.module]?.relatedlists && (
                <button
