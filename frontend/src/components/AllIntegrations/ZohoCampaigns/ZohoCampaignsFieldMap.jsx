...
export default function ZohoCampaignsFieldMap({
  i,
  formFields,
  field,
  campaignsConf,
  ...
  const isNotRequired =
    field.zohoFormField === '' ||
    campaignsConf.default.fields[campaignsConf.list].required?.indexOf(field.zohoFormField) === -1
  ...
  return (
    <div className={`flx flx-around mt-2 ${isNotRequired && 'mr-1'}`}>
      ...
      {field.formField === 'custom' && (
        <TagifyInput
          onChange={e => handleCustomValue(e, i, campaignsConf, setCampaignsConf)}
      ...
      <select
        ...
        {isNotRequired ? (
          ...
          campaignsConf.default.fields[campaignsConf.list].fields.map(
            contactField =>
