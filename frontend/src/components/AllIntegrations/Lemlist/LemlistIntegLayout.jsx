...
export default function LemlistIntegLayout({
  formFields,
  lemlistConf,
  setLemlistConf,
  isLoading,
      ...
      {(lemlistConf?.campaignsId || lemlistConf?.default?.fields) && (
        <>
          ...
          <div className="flx flx-around mt-2 mb-2 btcbi-field-map-label">
            ...
            <div className="txt-dp">
              <b>{__('Lemlist Fields', 'bit-integrations')}</b>
            </div>
          </div>
          ...
          <div className="btcd-hr mt-1" />
          <LemlistActions lemlistConf={lemlistConf} setLemlistConf={setLemlistConf} />
        </>
      )}
    </>
  )
