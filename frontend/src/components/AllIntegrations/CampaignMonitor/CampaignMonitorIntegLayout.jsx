...
export default function CampaignMonitorIntegLayout({
  ...
  return (
    <>
      ...
      <select
        value={campaignMonitorConf?.listId}
        name="listId"
        id=""
      ...
      {!isLoading && (campaignMonitorConf?.listId || campaignMonitorConf?.default?.fields) && (
        <>
          ...
          <div className="flx flx-around mt-2 mb-2 btcbi-field-map-label">
            ...
            <div className="txt-dp">
              <b>{__('CampaignMonitor Fields', 'bit-integrations')}</b>
            </div>
          </div>
          ...
          <div className="txt-center btcbi-field-map-button mt-2">
            <button
              onClick={() =>
                addFieldMap(
                  campaignMonitorConf.field_map.length,
                  campaignMonitorConf,
                  setCampaignMonitorConf
                )
              }
