    ...
    if (e.target.name === 'pipeline') {
      setHubspotConf(prevConf =>
        create(prevConf, draftConf => {
          ...
          draftConf.stageTmp = hubspotConf?.default?.pipelines
            .filter(({ pipelineId }) => pipelineId === e.target.value)
            .map(({ stages }) => stages)
        })
      )
    }
  ...
  return (
    <>
      ...
      {loading.hubSpotFields &&
        (hubspotConf?.actionName === 'deal' || hubspotConf.actionName === 'ticket') && (
          <>
            <div className="flx">
      ...
      {loading.hubSpotFields && (
        <div>
          ...
          <div className="flx flx-around mt-2 mb-2 btcbi-field-map-label">
            ...
            <div className="txt-dp">
              <b>{__('Hubspot Fields', 'bit-integrations')}</b>
            </div>
          </div>
