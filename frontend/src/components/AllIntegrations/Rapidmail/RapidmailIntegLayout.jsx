...
const note = `
    <h4>${__(
      'To ensure compatibility during data imports, use the following date formats:',
      'bit-integrations'
    )}</h4>
    <ul>
      <li>${__(
        '<b>Preferred format:</b> YYYY-MM-DD (ISO 8601, e.g., 2025-12-31) for the highest compatibility.',
        'bit-integrations'
      )}</li>
      <li>${__(
        '<b>Time data:</b> If including time, use YYYY-MM-DD HH:mm (e.g., 2025-12-31 14:30).',
        'bit-integrations'
      )}</li>
  </ul>
  `
