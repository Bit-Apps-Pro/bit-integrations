    ...
    <>
      ...
      <div className="flx">
        ...
        <MultiSelect
          ...
          options={
            mailPoetConf?.default?.newsletterList &&
            Object.keys(mailPoetConf.default.newsletterList).map((newsletter) => ({
              label: mailPoetConf.default.newsletterList[newsletter].newsletterName,
              value: mailPoetConf.default.newsletterList[newsletter].newsletterId
            }))
          }
      ...
      {mailPoetConf?.lists && (
        <>
          ...
          <div className="flx flx-around mt-2 mb-2 btcbi-field-map-label">
            ...
            <div className="txt-dp">
              <b>{__('MailPoet Fields', 'bit-integrations')}</b>
            </div>
          </div>
