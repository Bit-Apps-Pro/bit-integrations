...
export default function FluentCommunityActions({
  ...
  return (
    <div className="pos-rel d-flx w-8">
      <TableCheckBox
        checked={fluentCommunityConf.actions?.skip_if_exists || false}
      ...
      />
      <TableCheckBox
        checked={fluentCommunityConf.actions?.double_opt_in || false}
      ...
      />
      <TableCheckBox
        checked={fluentCommunityConf.actions?.company_id || false}
        ...
        <ConfirmModal
          ...
          {loading?.company ? (
            ...
            <div className="flx flx-center mt-2">
              <MultiSelect
                options={
                  fluentCommunityConf?.companies &&
                  fluentCommunityConf.companies.map((item) => ({
                    label: item.label,
