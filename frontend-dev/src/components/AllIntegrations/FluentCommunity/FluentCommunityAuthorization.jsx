    ...
    <>
      <div
        ...
        {fluentCommunity?.youTubeLink && (
          <TutorialLink title="FluentCRM" youTubeLink={fluentCommunity?.youTubeLink} />
        )}
        {fluentCommunity?.docLink && (
          <TutorialLink title="FluentCRM" docLink={fluentCommunity?.docLink} />
        )}
