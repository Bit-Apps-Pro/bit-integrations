...
import {
  ...
  getSingleOneDriveFolders,
  handleInput,
  handleActionChange
} from './OneDriveCommonFunc'
import TableCheckBox from '../../Utilities/TableCheckBox'
import OneDriveCreateFolderMap from './OneDriveCreateFolderMap'
...
export default function OneDriveIntegLayout({
  ...
  return (
    <>
      ...
      {oneDriveConf.actions?.create_folder && (
        <OneDriveCreateFolderMap
      ...
      {!oneDriveConf.actions?.create_folder && (
        <>
          ...
          <select
            onChange={e =>
              handleInput(e, oneDriveConf, setOneDriveConf, formID, setIsLoading, setSnackbar)
            }
            name="folder"
