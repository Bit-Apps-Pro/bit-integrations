  ...
  return (
    <>
      ...
      <div className="pos-rel d-flx w-8">
        ...
        {[
          TASK_LIST_VALUES.CREATE_CONTACT,
          TASK_LIST_VALUES.UPDATE_CONTACT,
          TASK_LIST_VALUES.CREATE_OPPORTUNITY,
          TASK_LIST_VALUES.UPDATE_OPPORTUNITY
        ].includes(highLevelConf.selectedTask) && (
          <>
            <TableCheckBox
